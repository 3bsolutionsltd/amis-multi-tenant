...
const ALL_NAV: NavItem[] = [
  ...
  { label: "Student Promotion",  route: "/students/promotion"       },
  ...
  { label: "Marksheet",          route: "/marks/marksheet"         },
  ...
  { label: "Class List Report",  route: "/reports/class-list"       },
  { label: "Fee Collection",     route: "/reports/fee-collection"   },
  { label: "IT Reports",         route: "/reports/it"               },
  { label: "Instructor Reports", route: "/reports/instructor"       },
  { label: "Evaluations",        route: "/reports/evaluations"      },
...
const ROLE_FALLBACK_NAV: Record<string, string[]> = {
  ...
  registrar: [
    ...
    "/marks", "/marks/marksheet", "/results", "/clearance", "/users",
  ],
  finance: [
    "/", "/finance", "/finance/reconciliation", "/students", "/admissions",
  ],
  hod: [
    "/", "/marks", "/marks/marksheet", "/results", "/staff", "/timetable", "/attendance", "/clearance",
  ],
  instructor: [
