...
export const CreateStudentSchema = z.object({
  ...
  sponsorship_type: z.enum(["Government", "Private"]),
  residence_category: z.enum(["day", "boarding"]),
  ...
  assessment_level: z.number().int().min(1).max(4).optional(),
...
export const UpdateStudentSchema = z.object({
  ...
  residence_category: z.enum(["day", "boarding"]).optional(),
